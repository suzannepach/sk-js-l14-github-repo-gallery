...
// This variable selects the search input box.
...
const displayRepoInfo = function (repoInfo, languages) {
    ...
    repoInfoElement.innerHTML= 
        ...
        <a class="visit" href="https://suzannepach.github.io/${repoInfo.name}" target="_blank" rel="noreferrer noopener">View website</a>
        `;
...
filterInput.addEventListener("input", function(e) {
    ...
    for (const repo of repos) {
        const repoLowerText = repo.innerHTML.toLowerCase();
